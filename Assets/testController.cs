...
public class testController : MonoBehaviour
{
	...
	void CalculatHover()
	{
		...
		if (isOnGround)
		{
			...
			groundNormal = BarycentricCoordinateInterpolator.GetInterpolatedNormal(hitInfo);
	...
	void CalculatePropulsion()
	{
		...
		Vector3 sideFriction = -transform.right * (sidewaysSpeed / (Time.fixedDeltaTime/ turnSpeed));
